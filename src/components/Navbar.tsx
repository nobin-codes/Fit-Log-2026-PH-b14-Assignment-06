    ...
    <header className="sticky top-0 z-50 border-b border-[#242824] bg-[#0b0d0c]">
      ...
      <div className="container-fitlog relative grid h-[70px] grid-cols-[auto_minmax(0,1fr)_auto] items-center gap-2 sm:grid-cols-[1fr_auto_1fr] sm:gap-0">
        ...
        <nav className="hidden items-center gap-2 sm:flex">
          ...
          <Link
            href="/"
            className={`rounded-full px-4 py-2 text-[12px] font-bold uppercase tracking-[0.08em] ${workoutActive ? "bg-[#1A2312] !text-[#C2F800]" : "!text-[#a0a59f]"}`}
          >
            {" "}
            Workout{" "}
          </Link>{" "}
          <Link
            href="/my-plan"
            className={`rounded-full px-4 py-2 text-[12px] font-bold uppercase tracking-[0.08em] ${myPlanActive ? "bg-[#1A2312] !text-[#C2F800]" : "!text-[#a0a59f]"}`}
          >
            {" "}
            My Plan{" "}
          </Link>{" "}
        ...
        <button
          ...
          className="absolute right-0 top-1/2 flex h-9 w-9 -translate-y-1/2 items-center justify-center rounded-full border border-[#343840] text-[#a5a9b0] sm:hidden"
        >
          {" "}
        ...
        <nav className="border-t border-[#242824] px-5 py-3 sm:hidden">
          ...
          <div className="flex flex-col gap-1">
            ...
            <Link
              ...
              className={`rounded-lg px-4 py-3 text-[12px] font-bold uppercase tracking-[0.08em] ${workoutActive ? "bg-[#1A2312] !text-[#C2F800]" : "!text-[#a0a59f]"}`}
            >
              {" "}
              Workout{" "}
            </Link>{" "}
            <Link
              href="/my-plan"
              onClick={() => setMenuOpen(false)}
              className={`rounded-lg px-4 py-3 text-[12px] font-bold uppercase tracking-[0.08em] ${myPlanActive ? "bg-[#1A2312] !text-[#C2F800]" : "!text-[#a0a59f]"}`}
            >
              {" "}
              My Plan{" "}
            </Link>{" "}
